...
<html>
  ...
  <body>
    <h3 align="center" class="demo-logo">Error! Set a correct AGE! Just Numbers!</h3><br>
    <div align="center"><br>
  <div class="container"> 
      <div class="row demo-row">
        <div class="span3">
          <div align="center"><a href="javascript:history.go(-1);" class="btn btn-large btn-block btn-danger">返回上页</a></div>
        </div>
      </div> <!-- /row -->
    </div> <!-- /container -->
   <br>
